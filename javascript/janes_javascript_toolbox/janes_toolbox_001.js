...
window.J = function(){
	...
	var xWindow = new (function(){})();
		var xNavigator = new (function(){})();
		var xScreen = new (function(){})();
		var xHistory = new (function(){})();
		var xLocation = new (function(){})();
		
		var xDocument = new (function(){})();
			var xEvent = new (function(){})();
			var xElement = new (function(){})();		
			var xHead = new (function(){})();
			var xBody = new (function(){})();
				var xAnchor = function(){};
...
// STRING related
	function xString( value ){		
		...
		*/
		...
		// generate / unique
		// wordWrap
		// numWords / numSpaces / numSentences
		// indexesOf
		// removePlusWhiteSpace
		// firsLetterUppercase / firstOfEachWordUppercase
		// insert( what , where , overwrite )
		// move ( from , what , where )
		// reverse
		// Regex
			// - test
		...
		// hash( ... )
		// .split( regex )
    	// .indexOf( regex ) / .lastIndexOf( regex )
    	// .search( regex / string , from , to / length )
    	// set/get .charAt/charCodeAt(  )
...
function Q() {
    ...
    if (this instanceof Q && !this.__previouslyConstructedByX) {
        isConstructor = true;
...
function xDiv( object , returnAs ) {
	var asConstructor = false;
	/* new xDiv() */
	if (this instanceof xDiv && !this.___previouslyConstructed) {
        asConstructor = true;
        this.___previouslyConstructed = true;
    } 
	/* xDiv( ... ) */
	else {
	...
	var d = document.createElement('a');
		...
		d.style.backgroundColor = 'rgba(0%,100%,0%,0.5)';
		
		//trace( d.style.left == '' , d.style.right == '' );
	var s = d.style;
	...
	if( arguments.length > 0 ) {
		trace( arguments[0] , typeof arguments[0] );
	}
	
	this.raw = this.div = d;
	
	this.addListener = this.addEvent = function() {};
	
	this.num = this.numChildren = function() {};
	this.hasChild = function() {};
	this.has = this.hasChildren = function() {};
	
	this.addChild = function() {};
	this.getChild = function() {};
	this.removeChild = function() {};
	
	this.add = this.addChildren = function() {};
	this.get = this.getChildren = function() {};
	this.remove = this.removeChildren = function() {};
...
window.onload = function() {
	...
	/*
	var d = new xDiv( document.createElement('div') );		
	document.body.appendChild( d );
		//d.x(24);
		//d.style.left = '';
		trace( d.id , d.type );		
	trace( document.body.innerHTML );
	*/

	//xString().generate();
	
	//trace( parseInt( Math.random() * ( 2 ) ) );
	
	/*
	var t = new Date().getTime();
	
	for( var i = 0 ; i < 5000 ; i++ ) {
		var s = xString().generate();
	}	
	
	trace( 't:' , new Date().getTime() - t );
	...
	*/
	...
	/*
	var s = xString( 'segítőkész űrőrző' ).deaccent();	
	trace( s );
	*/
	
	/*
	var a = xString().deaccent.a;	
	for( var i = 0; i < a.length ; i+=2 ) {
		trace( 'letter:' , a[i] , 'regex:' , a[i+1] );
	}
	*/
